...
export const DialogItemDelete = ({ handleDeleteMenu, isDeleting }: DialogDeleteProps) => {
    return (
        <DialogContent className="max-w-sm rounded-2xl p-6 shadow-xl [&>button]:hidden">
          ...
          <DialogDescription className="text-base text-slate-600">
            ¿Estás seguro de que deseas eliminar esta item? Esta acción no se puede deshacer.
          </DialogDescription>
